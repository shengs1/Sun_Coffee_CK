...
<c:set var="activePage" value="employees"/><c:set var="pageTitle" value="Quản lý nhân viên"/>
...
<body><div class="app-wrapper"><%@ include file="../components/header.jsp" %><%@ include file="../components/sidebar-admin.jsp" %><main class="main-content"><div class="page-header d-flex justify-between align-center flex-wrap gap-1"><div><h2>👥 Quản lý nhân viên</h2><p>Danh sách nhân viên Sun Coffee</p></div><button class="btn btn-primary" onclick="openModal('modal-add-employee')">Thêm nhân viên</button></div>
...
<div class="filter-bar"><div class="search-box"><span class="search-icon">🔍</span><input class="search-input" placeholder="Tìm nhân viên..." oninput="searchAnyTable(this.value,'employee-table')"></div></div>
